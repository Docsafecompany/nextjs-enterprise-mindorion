...
const features = {
  ...
  pro: [
    "Up to 5 users included (extra seats /user/mo)",
...
export default function PricingPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <style jsx global>{
        .plan { @apply rounded-2xl border bg-white p-6 shadow-sm; }
        .plan.highlight { @apply border-indigo-200 bg-indigo-50/50 ring-1 ring-indigo-200; }
        .btn-primary { @apply inline-flex w-full items-center justify-center rounded-xl bg-indigo-600 px-5 py-2.5 font-semibold text-white shadow-sm hover:bg-indigo-700; }
        .price { @apply text-5xl font-extrabold tracking-tight; }
        .check { @apply mr-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-indigo-600 text-[10px] font-bold text-white; }
        .feature { @apply flex items-start; }
      }</style>
    </main>
  );
}
